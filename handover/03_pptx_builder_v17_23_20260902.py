...
def draw_category(slide, palette, data, _fallback_from=None):
    ...
    Args:
        ...
        data    : {'title': str,
                   'categories': [{'label': str, 'score': int|None,  # 0〜100（40未満は警告色）
                                   'description': str}, ...]}
    Returns:
        dict : 描画レポート
    ...
    Args:
        data : {'title': str,
                ...
                'components': [{'label': str, 'value': int|float,
                                'score': int|None, 'note': str}, ...]}  # 0〜100（40未満は警告色）
...
def draw_comparison(slide, palette, data):
    ...
    Args:
        data : {'title': str,
                ...
                'items': [{'label': str, 'score': int|None,  # 0〜100（40未満は警告色）
...
def draw_pyramid(slide, palette, data):
    ...
    Args:
        data : {'title': str,
                'levels': [{'label': str, 'score': int|None,  # 0〜100（40未満は警告色）
...
def draw_sequence(slide, palette, data):
    ...
    Args:
        data : {'title': str,
                'steps': [{'label': str, 'score': int|None,  # 0〜100（40未満は警告色）
                           'description': str}, ...]}    # 3〜6
    ...
    Args:
        data : {'title': str,
                ...
                'cells': [{'row': int, 'col': int, 'label': str,
                           'score': int|None, 'items': [str]}, ...]}  # score:0〜100（40未満警告色）／要素数4〜9
...
def draw_funnel(slide, palette, data):
    ...
    Args:
        data : {'title': str,
                'stages': [{'label': str, 'score': int|None,  # 0〜100（40未満は警告色）
...
def draw_cycle(slide, palette, data):
    ...
    Args:
        data : {'title': str,
                ...
                'phases': [{'label': str, 'score': int|None,  # 0〜100（40未満は警告色）
                            'description': str}, ...]}    # 3〜6
    Returns:
        dict : 描画レポート
...
def draw_contrast(slide, palette, data):
    ...
    Args:
        data : {'title': str,
                'sides': [{'label': str, 'score': int|None,  # 0〜100（40未満は警告色）
                           'items': [str]}, ...]}     # ⚠️ 2固定
    Returns:
        dict : 描画レポート
