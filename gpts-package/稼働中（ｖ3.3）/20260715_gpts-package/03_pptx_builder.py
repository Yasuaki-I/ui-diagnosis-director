...
def add_visual_board(prs, visual_data, page_num=1, total=3, slide_no='3',
    ...
    # v15: end=158+68+12+200=438（行動フロー帯 top=444 との安全余白6px）
    # v14: end=158+62+12+200=432（右カラム下端434とほぼ同値・±2px許容）
    ISSUE_H = 200
    ...
    # [v15/2026-07-12] 22字境界超えでLibreOffice描画時に折返し発生する場合
    # に備え、line_height 1.35→1.2（連続感）＋ space_after_pt=8pt（項目間余白）
    # で強み側と同じ設計思想に統一。
    issue_paragraphs = [
